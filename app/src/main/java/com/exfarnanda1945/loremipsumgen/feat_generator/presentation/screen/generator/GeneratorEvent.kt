...
sealed class GeneratorEvent {
    ...
    data class OnMoreOptionExpanded(val isMoreOptionExpanded: Boolean) : GeneratorEvent()
    data class OnHtmlOptionExpanded(val isHtmlOptionExpanded: Boolean) : GeneratorEvent()
